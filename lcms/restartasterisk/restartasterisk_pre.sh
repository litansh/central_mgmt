...
#-- Permanent Variables
HIP="$(sed -n '1p' /var/www/lcms/modules/restartasterisk/restartasteriskdir/restartasteriskparam)"
USER="$(sed -n '1p' /var/www/lcms/modules/restartasterisk/loggeduserdir/loggeduser)"
FILE="${USER}.txt"
STAT="stat.txt"
...
chmod +x /var/www/lcms/modules/restartasterisk/restartasterisk.sh
...
function ssh_ () {
HIP="$(sed -n '1p' /var/www/lcms/modules/restartasterisk/restartasteriskdir/restartasteriskparam)"
sudo -uroot ssh -p'22' root@${HIP} 'bash -s' < /var/www/lcms/modules/restartasterisk/restartasterisk.sh
sudo -uroot ssh -p'44455' root@${HIP} 'bash -s' < /var/www/lcms/modules/restartasterisk/restartasterisk.sh
sudo -uroot ssh -p'44433' root@${HIP} 'bash -s' < /var/www/lcms/modules/restartasterisk/restartasterisk.sh
sudo -uroot ssh -p'33333' root@${HIP} 'bash -s' < /var/www/lcms/modules/restartasterisk/restartasterisk.sh
sudo -uroot ssh -p'51111' root@${HIP} 'bash -s' < /var/www/lcms/modules/restartasterisk/restartasterisk.sh
}
...
rm -rf /var/www/lcms/modules/restartasterisk/${FILE}
rm -rf /var/www/lcms/modules/restartasterisk/restartasteriskdir
rm -rf /var/www/lcms/modules/restartasterisk/loggeduserdir
