...
<body>
    <div align="center" class="center">
        <form class="form" action="changesshport_fun.php" method="POST">
            <p>Connect to Host IP:</p>
 <div class="select">
...
<br><br>
			<p>Change to Port Number:</p>
               <input name="pnumto" type="text" placeholder="Change to Port" class="blockb" required />
            <br><br>
